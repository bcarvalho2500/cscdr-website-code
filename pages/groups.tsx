    ...
    return (
        <div className="grid grid-cols-1 md:flex md:flex-col md:min-h-screen">
            ...
            <main className="flex-auto container mx-auto">
				<div className="text-center md:text-left text-2xl font-bold mt-4">Research Groups</div>
                ...
                <div className='divide-y divide-black md:divide-none'>
                    <div className='grid grid-cols-1 justify-items-center md:flex md:w-full my-4'>
                        <div className='grid md:flex min-w-fit min-h-fit my-4 md:my-0'>
                            <Image src='/images/fluid.jpeg' layout='intrinsic' width={350} height={251} alt='Picture of a fluid'/>
                        </div>
                        <div className='grid justify-items-center md:flex md:flex-col w-auto mx-4 md:border-black border-b-[1px]'>
                            <div className='text-xl font-semibold text-gray-600'>Numerical PDE Research Group</div>
                    ...
                    <div className='grid grid-cols-1 justify-items-center md:flex md:w-full my-4'>
                        <div className='grid justify-items-center md:flex md:flex-col w-auto mx-4 md:border-black border-b-[1px]'>
                            <div className='text-xl font-semibold text-gray-600 underline'><a href='http://gravity.phy.umassd.edu/main.html' target='_blank' rel='noopener noreferrer'>Gravity Research Group</a></div>
                            <p className='grid md:flex'>
                        ...
                        <div className='grid md:flex min-w-fit min-h-fit'>
                            <Image src='/images/spinfoam.jpeg' layout='intrinsic' width={350} height={251} alt='Picture of a fluid'/>
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 justify-items-center md:flex md:w-full my-4'>
                        <div className='grid md:flex min-w-fit min-h-fit my-4 md:my-0'>
                            <iframe src="https://docs.google.com/file/d/0Bys2wwqCX2u7ME9nQUdwbDdBWnc/preview?pli=1" width='350'height="251"></iframe>
                        </div>
                        <div className='grid justify-items-center md:flex md:flex-col w-auto mx-4 md:border-black border-b-[1px]'>
                        <div className='text-xl font-semibold text-gray-600 underline'><a href='https://sites.google.com/site/fishercompgroup/' target='_blank' rel='noopener noreferrer'>Computational Astrophysics</a></div>
                            <p className='grid md:flex'>
                            CA group is interested in computational and theoretical studies of giant molecular clouds, star formation, and Type Ia supernovae. Core faculty members for this group:
                            </p>
                            <div className='flex mt-3'>
                                <ul className='list-disc mx-8'>
                                    <li>Scott Field</li>
                    ...
                    <div className='grid grid-cols-1 justify-items-center md:flex md:w-full my-4'>
                        <div className='grid justify-items-center md:flex md:flex-col w-auto mx-4 md:border-black border-b-[1px]'>
                            <div className='text-xl font-semibold text-gray-600 underline'><a href='http://www.faculty.umassd.edu/mehdi.raessi/index.html' target='_blank' rel='noopener noreferrer'>Computational Multiphase Flows</a></div>
                            <p className='grid md:flex'>
                    ...
                    <div className='grid grid-cols-1 justify-items-center md:flex md:w-full my-4'>
                        <div className='grid md:flex min-w-fit min-h-fit my-4 md:my-0'>
                            <Image src='/images/oceansimul.jpeg' layout='intrinsic' width={350} height={251} alt='Picture of a fluid'/>
                        </div>
                        <div className='grid justify-items-center md:flex md:flex-col w-auto mx-4 md:border-black border-b-[1px]'>
                        <div className='text-xl font-semibold text-gray-600 underline'><a href='http://oceanphysics.blogs.umassd.edu/' target='_blank' rel='noopener noreferrer'>Computational Ocean Processes</a></div>
                            <p className='grid md:flex'>
                            Our research group is involved in computational and theoretical studies of the upper ocean submesoscale and mesoscale processes. This multiscale problems spans the small scale turbulence (mm scale) and oceanic mixed-layer processes to sub-mesoscale frontal gradients (Km scale) and mesoscale ocean eddies (hundreds of kms), and their role in setting up the large-scale balances in the ocean at the scale of the planet Earth. Core faculty members for this group:                            </p>
                            <div className='flex mt-3'>
                                <ul className='list-disc mx-8'>
                    ...
                    <div className='grid grid-cols-1 justify-items-center md:flex md:w-full my-4'>
                        <div className='grid justify-items-center md:flex md:flex-col w-auto mx-4 md:border-black border-b-[1px]'>
                            <div className='text-xl font-semibold text-gray-600'>Computational Solid and Structural Mechanics (CS2M)</div>
                            <p className='grid md:flex'>
                        ...
                        <div className='grid md:flex min-w-fit min-h-fit'>
                            <Image src='/images/cs2mpict.jpeg' layout='intrinsic' width={350} height={251} alt='Picture of a fluid'/>
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 justify-items-center md:flex md:w-full my-4'>
                        <div className='grid md:flex min-w-fit min-h-fit my-4 md:my-0'>
                            <Image src='/images/cmerg_resized.jpeg' layout='intrinsic' width={350} height={251} alt='Picture of a fluid'/>
                        </div>
                        <div className='grid justify-items-center md:flex md:flex-col w-auto mx-4 md:border-black border-b-[1px]'>
                        <div className='text-xl font-semibold text-gray-600'>Computational Mathematics Education</div>
                            <p className='grid md:flex'>
                    ...
                    <div className='grid grid-cols-1 justify-items-center md:flex md:w-full my-4'>
                        <div className='grid justify-items-center md:flex md:flex-col w-auto mx-4 md:border-black border-b-[1px]'>
                            <div className='text-xl font-semibold text-gray-600'>Data Science</div>
                            <p className='grid md:flex'>
                        ...
                        <div className='grid md:flex min-w-fit min-h-fit'>
                            <Image src='/images/datascience-wordcloud.png' layout='intrinsic' width={350} height={251} alt='Picture of a fluid'/>
                        </div>
                    </div>
