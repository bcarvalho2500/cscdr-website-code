...
import { authorizedUsers, server } from '../../config'
		...
		return (
			<>
				<div className='flex justify-between my-4'>
					<div className='flex flex-col'>
						<div className='cursor-pointer underline font-semibold'>
							<Link href='/people/directorate'>Directorate</Link>
						</div>
						{props.peopleData
					...
					<div className='flex flex-col'>
						<div className='cursor-pointer underline font-semibold'>
							<Link href='/people/faculty'>Faculty</Link>
						</div>
						{props.peopleData
							.filter((person: IPerson) => {
					...
					<div className='flex flex-col'>
						<div className='cursor-pointer underline font-semibold'>
							<Link href='/people/phd_students'>Ph.D Students</Link>
						</div>
						{props.peopleData
							.filter((person: IPerson) => {
				...
				<div className='flex flex-col w-full my-4'>
					<div className='font-semibold'>Advising Board</div>
					<hr className='border-black border mb-2' />
					<div className='flex justify-between'>
						<div className='font-semibold'>Name</div>
						<div className='font-semibold'>Affiliation</div>
            ...
            <main className="flex-auto container mx-auto">
                <div className='flex w-full'>
					...
					<div className='flex items-center justify-end w-full'>
						{(user && authorizedUsers.includes(user.email as string))? <AddItemsBtn /> : null}
					</div>
				</div>
				<hr className='border-black border mb-2' />
				{createMode ? (
